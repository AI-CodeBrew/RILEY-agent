        ...
        return (
          ...
          >
            <span className="relative">
              ...
              {badgeCount > 0 && (
                <span className="absolute -right-2 -top-1.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-fuchsia-600 px-1 text-[10px] font-semibold leading-none text-white">
